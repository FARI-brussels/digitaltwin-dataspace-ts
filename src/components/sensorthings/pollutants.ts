...
export const POLLUTANTS: Record<string, PollutantDefinition> = {
    ...
    'BC': {
        ...
        unit: 'µg/m³',
        unitName: 'Microgram per cubic meter',
        definition: 'http://dd.eionet.europa.eu/vocabulary/aq/pollutant/6015',
        unitDefinition: 'http://dd.eionet.europa.eu/vocabulary/uom/concentration/ug.m-3',
        aliases: ['bc', 'Black Carbon', 'black carbon']
    },
    'temperature': {
        id: 'temperature',
 ...
 */
function createFallbackDefinition(sourceProperty: string, unit?: string): PollutantDefinition {
    return {
        id: sourceProperty,
        name: sourceProperty,
